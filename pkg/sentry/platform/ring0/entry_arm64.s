...
MRS TPIDR_EL0, R9
MOVD R9, CPU_REGISTERS+PTRACE_R18(RSV_REG)
//WORD $0xd538d092   //MRS   TPIDR_EL1, R18
//WFI
	// Flush dcache.
...
// Copy r18 in memory -> tls
	MOVD RSV_REG, RSV_REG_APP
MOVD CPU_REGISTERS+PTRACE_R18(RSV_REG_APP), RSV_REG
//WFI
MSR RSV_REG, TPIDR_EL0
	MOVD RSV_REG_APP, RSV_REG
	MOVD CPU_REGISTERS+PTRACE_R9(RSV_REG), RSV_REG_APP
