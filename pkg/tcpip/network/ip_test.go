...
func TestIPv4Send(t *testing.T) {
	...
	ep, err := proto.NewEndpoint(1, localIpv4Addr, localIpv4PrefixLen, nil, nil, &o)
	if err != nil {
...
func TestIPv4Receive(t *testing.T) {
	o := testObject{t: t, v4: true}
	proto := ipv4.NewProtocol()
	ep, err := proto.NewEndpoint(1, localIpv4Addr, localIpv4PrefixLen, nil, &o, nil)
	if err != nil {
		t.Fatalf("NewEndpoint failed: %v", err)
	}
...
func TestIPv6Send(t *testing.T) {
	...
	ep, err := proto.NewEndpoint(1, localIpv6Addr, localIpv6PrefixLen, nil, nil, &o)
	if err != nil {
		t.Fatalf("NewEndpoint failed: %v", err)
	}
...
func TestIPv6Receive(t *testing.T) {
	o := testObject{t: t}
	proto := ipv6.NewProtocol()
	ep, err := proto.NewEndpoint(1, localIpv6Addr, localIpv6PrefixLen, nil, &o, nil)
	if err != nil {
		t.Fatalf("NewEndpoint failed: %v", err)
	}
